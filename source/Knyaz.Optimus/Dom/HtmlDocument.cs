...
namespace Knyaz.Optimus.Dom
{
	...
	public class HtmlDocument : Element
	{
		...
		internal HtmlDocument(IWindow window = null) : this("http://www.w3.org/1999/xhtml","html", null, window)
		{
		...
		internal HtmlDocument(string namespaceUri, string qualifiedNameStr, DocType docType, IWindow window) : base(null)
		{

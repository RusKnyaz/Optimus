...
namespace Knyaz.Optimus.ScriptExecuting.Jint
{
	...
	internal class JintJsScriptExecutor : IJsScriptExecutor
	{
		...
		private void CreateEngine(IWindowEx window, Func<Func<Stream, object>, XmlHttpRequest> createXmlHttpRequest)
		{
			...
			_jsEngine.AddGlobalType(typeof(HtmlBrElement));
			...
			_jsEngine.AddGlobalType(typeof(HtmlImageElement));
			_jsEngine.AddGlobalType(typeof(HtmlInputElement));
			_jsEngine.AddGlobalType(typeof(HtmlLabelElement));
			_jsEngine.AddGlobalType(typeof(HtmlLinkElement));
			_jsEngine.AddGlobalType(typeof(HtmlOptGroupElement));
			_jsEngine.AddGlobalType(typeof(HtmlOptionElement));
			_jsEngine.AddGlobalType(typeof(HtmlSelectElement));
			_jsEngine.AddGlobalType(typeof(HtmlStyleElement));
			_jsEngine.AddGlobalType(typeof(HtmlTextAreaElement));
			_jsEngine.AddGlobalType(typeof(HtmlTableElement));
			_jsEngine.AddGlobalType(typeof(HtmlTableRowElement));
			_jsEngine.AddGlobalType(typeof(HtmlTableColElement));
			_jsEngine.AddGlobalType(typeof(HtmlTableCellElement));
			_jsEngine.AddGlobalType(typeof(HtmlTableCaptionElement));
			_jsEngine.AddGlobalType(typeof(HtmlTableSectionElement));

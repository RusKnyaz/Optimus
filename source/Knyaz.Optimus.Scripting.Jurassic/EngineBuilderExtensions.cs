...
{
    /// <summary> Extends <see cref="EngineBuilder"/> class with the methods that configures Jurassic scripting engine. </summary>
    public static class EngineBuilderExtensions
    {
        ...
        public static EngineBuilder UseJurassic(this EngineBuilder builder) => 
            builder.JsScriptExecutor(JurassicFactory.Create);
    }
}
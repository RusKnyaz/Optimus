...
namespace Knyaz.Optimus.Tests.EngineTests
{
	...
	public class KnockoutTests
	{
		...
		Document Load(string script, string body)
		{
			var engine = new Engine();
			engine.Console.OnLog += o => System.Console.WriteLine(o.ToString());
			engine.Load("<html><head><script>" + R.knockout + "</script></head><body>" + body + "</body><script>" + script + "</script></html>");
			return engine.Document;
		}
		...
		{
			Load("<html><head><script> " + R.knockout + " </script></head><body></body></html>");
		}
...
";
			...
			var doc = Load("<html><head><script> " + R.knockout + " </script></head><body><span id = 'c1' data-bind='text:Greeting, click: Click'/></body>" +
...
ko.applyBindings(new VM());";
			...
			var doc = Load("<html><head><script> " + R.knockout + " </script></head>"+
				"<body>" +
...
";
			...
			var doc = Load("<html><head><script> " + R.knockout + " </script>" +
...
<script>
	ko.applyBindings({ html:'<script type=""text/javascript"">var d = document.createElement(""div"");d.id=""d""; document.body.appendChild(d);</script>' });
		...
		public void HtmlWithScriptBindingWithJquery()
		{
			var engine = new Engine();
			engine.Console.OnLog += o => System.Console.WriteLine(o.ToString());
			engine.Load("<html><head><script>" + R.jquery_2_1_3+"</script><script> " + R.knockout + " </script></head>" +
			            @"<body> <div id='view' data-bind=""html:html""></div> </body>
<script>
	ko.applyBindings({ html:'<script type=""text/javascript"">var d = document.createElement(""div"");d.id=""d""; document.body.appendChild(d);</script>' });
</script>

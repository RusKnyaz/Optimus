...
/usr/bin/dotnet test source/Knyaz.Optimus.sln --no-build
...
/usr/bin/dotnet pack source/Knyaz.Optimus/Knyaz.Optimus.csproj -c Release /p:Version=$version --no-build
